...
model = load_model('G:\Stock Project\Stock Prediction Model.keras')
...
plt.plot(ma_50_days, color = "red", label="MA 50 Days")
...
plt.plot(ma_50_days, color = "red", label="MA 50 Days")
plt.plot(ma_100_days, color = "blue", label="MA 100 Days")
plt.plot(data.Close, color = "green",  label="Close Price")
plt.legend()
st.pyplot(fig2)
...
plt.plot(predict, color = "red", label = 'Original Price')
